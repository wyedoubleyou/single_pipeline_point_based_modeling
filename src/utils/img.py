...
def crop_image(image, bbox, return_mask=False):
    ...
    image_pil = Image.fromarray(image, mode='RGB') 
        ...
        # expose <PIL.Image.Image image mode=RGB size=800x1200 at 0x7F5238874580>
        # itw <PIL.Image.Image image mode=RGB size=800x1200 at 0x7F786988AE80>
    # plt.imshow(image_pil)
    # plt.savefig(f'pil.png')
    # print(image_pil)


    image_pil = image_pil.crop(bbox)   #cropping issue 
        # expose <PIL.Image.Image image mode=RGB size=1303x1303 at 0x7F95E09C1E20>
        # itw <PIL.Image.Image image mode=RGB size=1314x1314 at 0x7F78698579D0> 
    # plt.imshow(image_pil)
    # plt.savefig(f'pil3.png')
    # print(image_pil)

    if return_mask: #<< going here 
